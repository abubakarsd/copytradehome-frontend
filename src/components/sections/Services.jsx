                    ...
                    <div className="col-xl-6 col-md-12">
                        <div className="services__main">
                            <div className="services-box">
                                ...
                                <a href="https://copytradehome.com/welcome/copy_trading" className="h6 title">Portfolio Manager</a>
                                <p>Buy and sell popular digital currencies, keep track of them in the one place.</p>
                            </div>
                            <div className="services-box">
                                <div className="icon">
                                    <svg width="31" height="36" viewBox="0 0 31 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M23.6095 13.3208V9.3846C23.6095 4.77743 19.8732 1.0411 15.266 1.0411C10.6589 1.02093 6.90786 4.73893 6.8877 9.34793V9.3846V13.3208" stroke="#58BD7D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                        ...
                                        <path d="M15.2486 22.0381V26.1099" stroke="#58BD7D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                    </svg>
                                </div>
                                <a href="https://copytradehome.com/#" className="h6 title">Vault Protection</a>
                            ...
                            <div className="services-box">
                                ...
                                <a href="https://copytradehome.com/#" className="h6 title">Mobile Apps</a>
                                <p>Stay on top of the markets with our app for Android or iOS.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6 col-md-12">
                        <div className="block-text aos-init" data-aos="fade-up" data-aos-duration="1000">
                            <h3 className="heading">The most trusted cryptocurrency platform.</h3>
                            <div className="">
                                <p>CopyTradeHome is a leading smart trading platform dedicated to empowering traders worldwide. With a commitment to innovation, expertise, and customer satisfaction, we provide a state-of-the-art trading environment that caters to both novice and experienced traders. Our platform offers real-time data, advanced charting tools, and comprehensive educational resources, ensuring our clients have the knowledge and tools they need to succeed.<br /><br />At CopyTradeHome, we prioritize security, transparency, and personalized support, making us your trusted partner in navigating the dynamic world of forex trading. Join us and elevate your trading experience with CopyTradeHome.</p>
                            </div>
                            <a href="/register" className="btn-action">Let's Trade Now</a>
                        </div>
                    </div>
                </div>
            </div>
